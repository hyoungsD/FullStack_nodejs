...
export class ProductsController {
  ...
  // Swagger에서 인증해야만 사용 가능
  @ApiBearerAuth()
  @ApiOperation({summary: '상품등록'})
  create(@Body() createProductDto: CreateProductDto, @CurrentUser() user: AuthUser) {
    console.log('--products.controller user--', user)
  ...
  @UseInterceptors(FileInterceptor('image', imageUploadOptions))  // image : 필드명, option
  addImage(
